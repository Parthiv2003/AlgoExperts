                    ...
                    <div className="card1">
                        <div className="container">
                            ...
                            <div className="tab-content">
                                <div id="all" className="tab-pane fade">
                                    <div className="inner-card">
                                        <div className="inner-container">
                                            ...
                                            <br/> <br/> <br/> <br/>
                                            <p className="expl">On a history lesson the teacher asked Vasya to name the dates when n famous events took place. He doesn't remembers the exact dates but he remembers a segment of days [l<sub>i</sub>, r<sub>i</sub>] (inclusive) on which the event could have taken place. However Vasya also remembers that there was at most one event in one day. Help him choose such n dates of famous events that will fulfill both conditions. It is guaranteed that it is possible.</p>
                                            <br/>

                                            <h4 className="head"> INPUT </h4>
                                            <br/> <br/> <br/> 
                                            <p className="expl">The first line contains one integer n (1 ≤ n ≤ 100) — the number of known events. Then follow n lines containing two integers l<sub>i</sub> and r<sub>i</sub> each (1 ≤ l<sub>i</sub> ≤ r<sub>i</sub> ≤ 10<sup>7</sup>) — the earliest acceptable date and the latest acceptable date of the i-th event.</p>
                                            <br/>

                                            <h4 className="head"> OUTPUT </h4>  
                                            <br/> <br/> <br/>  
                                            <p className="expl">Print n numbers — the dates on which the events took place. If there are several solutions, print any of them. It is guaranteed that a solution exists.</p> <br/>
                                            ...
                                            <table className="testcase expl">
                                                ...
                                                <tr>
                                                    <td className="input"> 1 &emsp; 2 </td>
                                                </tr>
                                                <tr>
                                                    <td className="input"> 2 &emsp; 3 </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table className="testcase expl">
                                                ...
                                                <tr>
                                                    <td className="output" style={{border: "1px solid gray"}}> 1 &emsp; 2 &emsp; 3 </td>
                                                </tr>
                                            </table>
                                            <br/>
                                            ...
                                            n = int(input()) <br/> <br/>
                                            seg = [] <br/> <br/>
                                            for i in range(n): <br/> &emsp;
                                            l, r = map(int, input().split())<br/> &emsp;
                                            seg.append((l, r, i))<br/> <br/>
                                            seg.sort(key=lambda tup: (tup[1], tup[0], tup[2])) <br/>
                                            assigned = set() <br/>
                                            ans = [0] * n <br/> <br/>
                                            for i in range(n):<br/> &emsp;
                                            # this loop won't run more than 100 times as n &lt;= 100<br/> &emsp;
                                            for j in range(seg[i][0], seg[i][1] + 1, 1):<br/> &emsp; &emsp;
                                            if j not in assigned: <br/> &emsp; &emsp; &emsp;
                                            ans[seg[i][2]] = j <br/> &emsp; &emsp; &emsp;
                                            assigned.add(j) <br/> &emsp; &emsp; &emsp;
                                            break <br/> <br/>  
                                            for i in range(n): <br/> &emsp;
                                            print(ans[i], end=' ')
                                            </div> 
                                ...
                                <p id="cf"> You can read on <a href="https://codeforces.com/contest/45/problem/D" target="_blank" id="cf_link"> Codeforcse</a></p>
