                    ...
                    <div className="card1">
                        <div className="container">
                            ...
                            <div className="tab-content">
                                <div id="all" className="tab-pane fade">
                                    <div className="inner-card">
                                        <div className="inner-container">
                                            ...
                                            <br/> <br/> <br/> <br/>
                                            <p className="expl">Iahub and his friend Floyd have started painting a wall. Iahub is painting the wall red and Floyd is painting it pink. You can consider the wall being made of a very large number of bricks, numbered 1, 2, 3 and so on. <br/> <br/> Iahub has the following scheme of painting: he skips x - 1 consecutive bricks, then he paints the x-th one. That is, he'll paint bricks x, 2·x, 3·x and so on red. Similarly, Floyd skips y - 1 consecutive bricks, then he paints the y-th one. Hence he'll paint bricks y, 2·y, 3·y and so on pink. <br/> <br/> After painting the wall all day, the boys observed that some bricks are painted both red and pink. Iahub has a lucky number a and Floyd has a lucky number b. Boys wonder how many bricks numbered no less than a and no greater than b are painted both red and pink. This is exactly your task: compute and print the answer to the question.</p>
                                            <br/>

                                            <h4 className="head"> INPUT </h4>
                                            <br/> <br/> <br/> 
                                            <p className="expl">The input will have a single line containing four integers in this order: x, y, a, b. (1 ≤ x, y ≤ 1000, 1 ≤ a, b ≤ 2·10<sup>9</sup>, a ≤ b).</p>
                                            <br/>

                                            <h4 className="head"> OUTPUT </h4>  
                                            <br/> <br/> <br/>  
                                            <p className="expl">Output a single integer — the number of bricks numbered no less than a and no greater than b that are painted both red and pink.</p> <br/>
                                            ...
                                            <table className="testcase expl">
                                                ...
                                                <tr>
                                                    <td className="input" style={{border: "1px solid gray"}}> 2 &emsp; 3 &emsp; 6 &emsp; 18 </td>
                                                </tr>
                                            </table>
                                            <br/>
                                            <table className="testcase expl">
                                                ...
                                                <tr>
                                                    <td className="output" style={{border: "1px solid gray"}}> 3 </td>
                                                </tr>
                                            </table>
                                            <br/>
                                            ...
                                            <br/> <br/> <br/>  
                                            <p className='expl'> Let's look at the bricks from a to b (a = 6, b = 18). The bricks colored in red are numbered 6, 8, 10, 12, 14, 16, 18. The bricks colored in pink are numbered 6, 9, 12, 15, 18. The bricks colored in both red and pink are numbered with 6, 12 and 18. </p>
                                            <br/>
                                            ...
                                            ll x,y,a,b; <br/> &emsp;
                                            cin&gt;&gt;x&gt;&gt;y&gt;&gt;a&gt;&gt;b; <br/> &emsp;
                                            ll lcm=(x*y)/__gcd(x,y); <br/> &emsp;
                                            i=(b/lcm)-((a-1)/lcm);<br/> &emsp;
                                            cout&lt;&lt;i; <br/>  &emsp;
                                            return 0; <br/>
                                            &#125;
                                            </div> 
                                ...
                                <div id="prexp" className="tab-pane fade">
                                    <div className="inner-card">
                                        ...
                                        <br/>
                                            ...
                                            <h4 className="head"> EXPLANATION </h4>  
                                            <br/> <br/> <br/>  
                                            <p className='expl'> Let's look at the bricks from a to b (a = 6, b = 18). The bricks colored in red are numbered 6, 8, 10, 12, 14, 16, 18. The bricks colored in pink are numbered 6, 9, 12, 15, 18. The bricks colored in both red and pink are numbered with 6, 12 and 18. 
                                            </p>
                                            <br/>
                                        </div>
                                    </div>
                                ...
                                <p id="cf" > You can read on <a href="https://codeforces.com/contest/340/problem/A" target="_blank" id="cf_link"> Codeforcse</a></p>
